                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-4 mt-2.5'>
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <div className='relative'>
                            ...
                            <button type='button' onClick={() => setShowPassword(prev => !prev)} className='absolute right-2 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-200 hover:scale-105 transition-all duration-200 cursor-pointer' aria-label={showPassword ? 'Hide password' : 'Show password'}>
                                {showPassword ? (
                                    // Eye-off icon
