...
const Profile = () => {
  ...
  return (
    <main className='max-w-275 mx-auto px-6 pt-6 pb-8 flex flex-col gap-6 min-h-dvh bg-slate-900 text-slate-100'>
      <section className='bg-slate-800 border border-slate-700 rounded-lg shadow-md p-6 flex flex-col gap-6'>
